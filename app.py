...
class Conv3DModel(tf.keras.Model):
  def __init__(self):
    ...
    self.pool1 = tf.keras.layers.MaxPool3D(pool_size=(27, 27, 27), data_format='channels_last')
    self.conv2 = tf.compat.v2.keras.layers.Conv3D(64, (3, 3, 3), activation='relu', name="conv1", data_format='channels_last')
    self.pool2 = tf.keras.layers.MaxPool3D(pool_size=(27, 27, 27), data_format='channels_last')
